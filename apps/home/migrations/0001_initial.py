# Generated by Django 3.2.13 on 2023-03-14 20:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='home.area')),
            ],
        ),
        migrations.CreateModel(
            name='ServiceRequest',
            fields=[
                ...
                ('Area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='home.area')),
                ('ComputoRegistrado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='home.computoregistrado')),
